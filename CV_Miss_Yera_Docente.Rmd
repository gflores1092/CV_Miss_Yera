...
#profilepic:
position: |
  | \scriptsize INGENIERA INDUSTRIAL MBA · DOCENTE UNIVERSITARIA · EDUCADORA · EXPERTA EN DATOS, ANALÍTICA E IA
#address:
phone: (+51) 948425000
...
spanish_summary <- c(
  "Ejecutiva senior con más de 12 años de experiencia en analítica avanzada, inteligencia artificial y estrategia comercial en empresas multinacionales a nivel LATAM. Ingeniera industrial con MBA y sólida trayectoria como docente de pregrado y postgrado en cursos de análisis y ciencia de datos, programación, inteligencia artificial y transformación digital."
)
...
spanish_prof_titles <- c(
                    "Docente", 
                    "Docente", 
                    "Docente"
                    )

spanish_prof_companies <- c(
                      "CENTRUM CATOLICA",
                      "MISS YERA", 
                      "CIBERTEC"
                      )

spanish_mentor_titles <- c(
                    "Mentora", 
                    "Capacitadora"
                    )

spanish_mentor_companies <- c(
                      "INCUBADORAS DE STARTUPS",
                      "COFIDE"
                      )

spanish_conf_titles <- c(
                    "Conferencista"
                    )

spanish_conf_companies <- c(
                      "MISS YERA"
                      )
spanish_titles <- c(
...
spanish_prof_bullets <- c(

  #[1]
  "Docente de postgrado en negocios, dictando cursos con enfoque en datos e IA en áreas como operaciones, RRHH, etc.",
  "Docente de educación ejecutiva, con enfoque en el uso de soluciones de tecnología para aplicaciones empresariales.",
  
  #[2]
  "Docente de cursos online y presenciales de IA, Machine Learning y análisis y ciencia de datos (SQL, Python, R, etc.).",
  "Ponente en conferencias y talleres de tecnología y universidades a nivel LATAM, y mentora en incubadoras de startups.",
  
  #[3]
  "Docente de herramientas de inteligencia de negocios como Power BI, Looker Studio, etc."
...
spanish_mentor_bullets <- c(

  #[1]
  "Mentora de emprendedores y startups en incubadoras como Bioincuba (UPCH) y 1551 (UNMSM).",
  
  #[2]
  "Capacito MYPES en materias de soluciones de datos, herramientas tecnológicas e Inteligencia Artificial."
...
spanish_conf_bullets <- c(

  #[1]
  "He dictado más de 50 conferencias a nivel LATAM en instituciones educativas, universidades, empresas, entre otros.",
  "He participado en ponencias en universidades como PUCP, UNI, UNMSM, UPN, UTP, UTEC, UNSA, entre otros.",
  "He realizado charlas y conferencias en entidades y empresas como Ingram Micro, Presente, entre otros."
...
spanish_hobbies <- tribble(~description,
        "Comparto contenido educativo en datos y analítica para una comunidad de más de 100k seguidores en redes sociales.",
...
if (lang == "English") {
    ...
    prof_titles <- spanish_prof_titles
    prof_companies <- spanish_prof_companies
    prof_bullets <- spanish_prof_bullets
    mentor_titles <- spanish_mentor_titles
    mentor_companies <- spanish_mentor_companies
    mentor_bullets <- spanish_mentor_bullets
    conf_titles <- spanish_conf_titles
    conf_companies <- spanish_conf_companies
    conf_bullets <- spanish_conf_bullets
...
```{r prof_experience, results='asis'}
tribble(~position, ~start, ~end,

        # Position
        title(prof_titles[1]), 2025, NA,
        company(prof_companies[1]), 2025, NA,
        bullet(prof_bullets[1]), 2025, NA,
        bullet(prof_bullets[2]), 2025, NA,
        "\\tiny", 2025, NA,

        # Position
        title(prof_titles[2]), 2024, NA,
        company(prof_companies[2]), 2024, NA,
        bullet(prof_bullets[3]), 2024, NA,
        bullet(prof_bullets[4]), 2024, NA,
        "\\tiny", 2024, NA,
        
        # Position
        title(prof_titles[3]), 2023, NA,
        company(prof_companies[3]), 2023, NA,
        bullet(prof_bullets[5]), 2023, NA,
        "\\tiny", 2023, NA,
...
\hspace{0.25cm}\color{black}{\Large\faBriefcase}\hspace{0.25cm}\section{`r sections[3]`}

\vspace{-0.375cm}

```{r mentor_experience, results='asis'}
tribble(~position, ~start, ~end,

        # Position
        title(mentor_titles[2]), 2025, NA,
        company(mentor_companies[2]), 2025, NA,
        bullet(mentor_bullets[2]), 2025, NA,
        "\\tiny", 2025, NA,
      
        # Position
        title(mentor_titles[1]), 2024, NA,
        company(mentor_companies[1]), 2024, NA,
        bullet(mentor_bullets[1]), 2024, NA,
        "\\tiny", 2024, NA,
...
\hspace{0.25cm}\color{black}{\Large\faBriefcase}\hspace{0.25cm}\section{`r sections[4]`}

\vspace{-0.375cm}

```{r conf_experience, results='asis'}
tribble(~position, ~start, ~end,

        # Position
        title(conf_titles[1]), 2024, NA,
        company(conf_companies[1]), 2024, NA,
        bullet(conf_bullets[1]), 2024, NA,
        bullet(conf_bullets[2]), 2024, NA,
        bullet(conf_bullets[3]), 2024, NA,
        "\\tiny", 2024, NA
...
\hspace{0.25cm}\color{black}{\Large\faBriefcase}\hspace{0.25cm}\section{`r sections[5]`}
...
# Nota: Si hay error aquí es por los putos porcentajes        
        ...
        # Position
        title(titles[1]), 2024, 2025,
        company(companies[1]), 2024, 2025,
        bullet(bullets[1]), 2024, 2025,
        "\\tiny", 2024, 2025,
...
\hspace{0.25cm}\color{black}{\Large\faGraduationCap}\hspace{0.25cm}\section{`r sections[6]`}
...
\hspace{0.25cm}\color{black}{\Large\faUniversity}\hspace{0.25cm}\section{`r sections[7]`}
...
\hspace{0.25cm}\color{black}{\Large\faList}\hspace{0.25cm}\section{`r sections[8]`}
...
\hspace{0.25cm}\color{black}{\Large\faBook}\hspace{0.25cm}\section{`r sections[9]`}
...
\hspace{0.25cm}\color{black}{\Large\faComment}\hspace{0.25cm}\section{`r sections[10]`}
...
tribble(~interest,
        "Información adicional en mi cuenta de \\textbf{\\href{https://www.linkedin.com/in/gflores1092/}{LinkedIn}}."
        ) %>%
        tabular()
```
