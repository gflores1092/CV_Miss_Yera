...
\hspace{0.25cm}\color{black}{\Large\faGraduationCap}\hspace{0.25cm}\section{`r sections[4]`}
...
\hspace{0.25cm}\color{black}{\Large\faUniversity}\hspace{0.25cm}\section{`r sections[5]`}
...
\hspace{0.25cm}\color{black}{\Large\faList}\hspace{0.25cm}\section{`r sections[6]`}
...
\hspace{0.25cm}\color{black}{\Large\faBook}\hspace{0.25cm}\section{`r sections[7]`}
...
\hspace{0.25cm}\color{black}{\Large\faComment}\hspace{0.25cm}\section{`r sections[8]`}
...
\hspace{0.25cm}\color{black}{\Large\faBalanceScale}\hspace{0.25cm}\section{`r sections[9]`}
